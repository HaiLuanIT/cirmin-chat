...
public class MessageService : IMessageService
{
    ...
    public async Task SendMessage(Guid senderId, SendMessageRequest request)
    {
        ...
        if (!isMember) throw new CirMinBadRequestException(ErrorCodes.Conversation.Forbidden);
    ...
    public async Task<long?> MarkAsSeen(Guid currentUserId, Guid conversationId)
    {
        ...
        if (member == null) throw new CirMinForbiddenException(ErrorCodes.Conversation.Forbidden);
