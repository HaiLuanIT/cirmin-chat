...
using Moji.API.IntegrationTests.Infrastructure;
using Moji.Contracts.Errors;
using Moji.Contracts.Models.Users.UpdateUserInfo;
using Moji.DataAccess.Entities;

namespace Moji.API.IntegrationTests.Users.UpdateUserInfo;
...
public class UpdateUserInfoTests : IAsyncLifetime
{
    ...
    private readonly MojiApiFactory _factory;

    public UpdateUserInfoTests(PostgreSqlFixture database)
    {
        _factory = new MojiApiFactory(database.ConnectionString);
